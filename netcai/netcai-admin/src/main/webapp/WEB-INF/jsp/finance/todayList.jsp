...
<body>
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <shiro:hasPermission name="todayStatistics:query">
	        ...
	        <div class="col-xs-12">
	          <div class="box">
	              <div class="box box-info">
		           <!-- form start -->
		           <form  id="form_submit" class="form-horizontal" action="<%=request.getContextPath()%>/admin/todayStatistics/list" method="post">
		             <div class="col-sm-12">
	                ...
	                <tbody>
		              	<c:forEach items="${lists}" var="list"> 
				   			 <tr>
							       ...
							       <td>${list.userNum}</td>
							       <td>${list.money}</td>
							       <td><fmt:formatNumber type="number" value="${list.money/list.userNum}" pattern="0.00" maxFractionDigits="2"/> </td>
				             </tr>
			             </c:forEach>
	                </tbody>
	              </table>
...
$(function() { 
    $("#export").click(function(){
    	window.location.href="/admin/statisticsToday/export?"+$('#form_submit').serialize();
    })
})
//初始化时间选择器
...
$(function(){
   $("#reset").click(function(){
	   window.location.href="/admin/todayStatistics/list";
   });
  });
//获取区域信息;
