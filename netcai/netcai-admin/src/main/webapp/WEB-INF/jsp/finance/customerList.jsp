...
<body>
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <shiro:hasPermission name="statisticsCustomer:query">
	        ...
	        <div class="col-xs-12">
	          <div class="box">
	              <div class="box box-info">
		           <!-- form start -->
		           <form  id="form_submit" class="form-horizontal" action="<%=request.getContextPath()%>/admin/statisticsCustomer/list" method="post">
		             <div class="col-sm-12">
	                ...
	                <tbody>
		              	<c:forEach items="${lists}" var="list"> 
				   			 <tr>
							       ...
							       <td>
								       <c:choose> 
										 <c:when test="${list.buyerLevel==1}">   
										   A
										 </c:when> 
										 <c:when test="${list.buyerLevel==2}">   
										   B
										 </c:when> 
										 <c:when test="${list.buyerLevel==3}">   
										   C
										 </c:when> 
										 <c:when test="${list.buyerLevel==4}">   
										   D
										 </c:when> 
										 <c:otherwise>   
							       			未知
...
$(function() { 
    $("#export").click(function(){
    	window.location.href="/admin/statisticsCustomer/export?"+$('#form_submit').serialize();
    })
})
...
$(function(){
   $("#reset").click(function(){
	   window.location.href="/admin/statisticsCustomer/list";
   });
  });
//获取区域信息;
