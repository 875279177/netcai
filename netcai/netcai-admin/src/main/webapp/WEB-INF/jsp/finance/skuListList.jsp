...
<body>
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <shiro:hasPermission name="statisticsSku:query">
	        ...
	        <div class="col-xs-12">
	          <div class="box">
	              ...
	              <div class="box box-info">
		           <!-- form start -->
		           <form  id="form_submit" class="form-horizontal" action="<%=request.getContextPath()%>/admin/statisticsSku/list" method="post">
		             <div class="col-sm-12">
...
$(function() { 
    $("#export").click(function(){
    	window.location.href="/admin/statisticsSku/export?"+$('#form_submit').serialize();
    })
})
//初始化时间选择器
...
$(function(){
   $("#reset").click(function(){
	   window.location.href="/admin/statisticsSku/list";
   });
  });
//获取区域信息;
