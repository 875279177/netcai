...
<body>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>${sysCommonVo.areaName}/${sysCommonVo.buyerType}/新增清单管理</h1>
    </section>
    <!-- Main content -->
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <!-- 表单start -->
            <form id="submitForm" class="form-horizontal" action="<%=request.getContextPath() %>/admin/sysCommon/toAdd" method="post" >
			       <input type="hidden" name="areaId" id="areaId" value="${sysCommonVo.areaId}"  class="layui-input" >
			       <input type="hidden" name="buyerTypeId" id="buyerTypeId" value="${sysCommonVo.buyerTypeId}" class="layui-input" >
			       <input type="hidden" name="areaName" id="areaName" value="${sysCommonVo.areaName}"  class="layui-input" >
			       <input type="hidden" name="buyerType" id="buyerType" value="${sysCommonVo.buyerType}" class="layui-input" >
               <input type="hidden" name="pageNum" id="pageNum" value="${paginator.currentPage}">
              <input type="hidden" name="pageSize" id="pageSize" value="${paginator.pageRecord}">
              <div class="col-sm-12" style="top: 20px">
                <div class="form-group" >
	              	<label for="searchName" class="col-sm-1 control-label">商品信息：</label>
	                 <div class="col-sm-2">
                 ...
                 <label for="categoryName" class="col-sm-1 control-label">商品分类：</label>
	                 <div class="col-sm-2">
              ...
              <div class="box-footer" style="top: 50px">
	                 <button type="reset" class="btn btn-info pull-right" onclick="clearSearch()">重置</button>
...
function clearSearch(){
  var areaId = ${sysCommonVo.areaId};
  var buyerTypeId = ${sysCommonVo.buyerTypeId};
  var areaName = "${sysCommonVo.areaName}";
  var buyerType = "${sysCommonVo.buyerType}";
   window.location.href="/admin/sysCommon/toAdd?areaId="+areaId+"&areaName="+areaName+"&buyerTypeId="+buyerTypeId+"&buyerType="+buyerType;
}
...
$(function() { 
    ...
    $("#save").click(function(){
	    ...
	    ,btn1: function(index){
	        	  $.ajax({  
			            url:"/admin/sysCommon/add",
			            data:{"goodsIds":goodsIds,"buyerTypeId":buyerTypeId,"areaId":areaId},
			            dataType:"json",  
			            success:function(data){ 
					        ...
					        layer.close(index);
			                location.href="/admin/sysCommon/toAdd?areaId="+areaId+"&areaName="+areaName+"&buyerTypeId="+buyerTypeId+"&buyerType="+buyerType+"&searchName="+searchName+"&categoryName="+categoryName+"&sellerName="+sellerName;
			            }  
			        });
	      }
	    ,btn2: function(index){
