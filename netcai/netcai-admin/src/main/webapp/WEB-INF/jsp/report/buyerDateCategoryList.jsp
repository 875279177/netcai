        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">商品分类统计</h3>
            </div>
            <!-- 表单start -->
           <form id="searchForm" class="form-horizontal" method="post" action="/admin/reportDay/buyerdate" >
              <div class="col-sm-12">
	             <div class="form-group">
	                 ...
	                 <label for="areaId" class="col-sm-1 control-label">状态：</label>
	                 <div class="col-sm-3" style="width: 180px">
	                   <select id="type" name="type" class="form-control">
	                       <option value="1" <c:if test="${search.type==1}">selected</c:if>>不包含退换货</option>
	                       <option value="2" <c:if test="${search.type==2}">selected</c:if>>包含缺货</option>
					   </select>
	                 </div>
        	...
        	<c:forEach items="${ocList}" var="o" > 
             	 <c:set var="totalNum" value="${totalNum+o.buyerNum}"></c:set>
            ...
            <div class="layui-form" >
              <table class="layui-table">
                <thead>
	              ...
	              <tr>
	                <th>总计</th>
	                <th style="color: red;">${totalNum}</th>
...
function exportExcel(){
	window.location.href="/admin/reportDay/buyer/export?"+$('#searchForm').serialize();
}
//初始化时间选择器
