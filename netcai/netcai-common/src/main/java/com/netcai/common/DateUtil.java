...
public class DateUtil {
	 ...
	 * 订单统计开始时间
	 */
	public static String TRADING_START = " 10:00:00";
	/**
	 * 订单统计结束时间
	 */
	public static String TRADING_END = " 05:59:59";
	/**
	 * 一天的开始时间
	 */
	public static String NOMAL_START = " 00:00:00";
	/**
	 * 一天的结束时间
	 */
	public static String NOMAL_END = " 23:59:59";
	
	/**
	 * 临时订单的结束时间
	 */
	public static String TEMPORARY_TRADING_END = " 18:00:00";
	...
	/**
	 * 获取格式化的n天前的时间格式为yyyy-MM-dd HH:mm:ss
	 * 
	 * @return
	 */
	public static Map<String, Object> getSomeDay(int n) {
		Map<String, Object> map = new HashMap<String, Object>();
		String timeStr = getNDayDateTimeStr(n) + NOMAL_START;
	 ...
	 * @return
	 */
	public static Map<String, Object> getCountOrderTime(String queryDate) {
		Map<String, Object> map = new HashMap<String, Object>();
		Date date = stringToDate(queryDate, "yyyy-MM-dd");
		String startTime = dateToString(addDay(date, -1),"yyyy-MM-dd") + TRADING_START;
		String endTime = queryDate + TRADING_END;
		map.put("startTime", startTime);
		map.put("endTime", endTime);
		return map;
	}
	 ...
	 * @return
	 */
	public static Map<String, Object> getCountOrderRefundTime(Date queryDate) {
		Map<String, Object> map = new HashMap<String, Object>();
		String startTime = dateToString(addDate(queryDate, 1, -1),"yyyy-MM-dd") + TRADING_START;
		String endTime = queryDate + TRADING_END;
		map.put("startTime", startTime);
		map.put("endTime", endTime);
		return map;
	 ...
	 * @return
	 */
	public static Map<String, Object> getTemporaryOrderTime(int n) {
		Map<String, Object> map = new HashMap<String, Object>();
		String startTimeStr = getNDayDateTimeStr(n) + TRADING_START;
		Date startTime = stringToDate(startTimeStr);
		String endTimeStr = getNDayDateTimeStr(n) + TEMPORARY_TRADING_END;
		Date endTime = stringToDate(endTimeStr);
		map.put("startTime", startTime);
		map.put("endTime", endTime);
		return map;
	...
	public static void main(String[] args) {
		Map<String,Object> map = DateUtil.getCountOrderTime("2017-08-24");
